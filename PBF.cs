...
public class PBF : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        computeShader.SetBuffer(Calculate_f_pressure_kernel, "particles", unsortedParticlesBuffer);
        ...
        computeShader.SetBuffer(Apply_f_pressure_kernel, "particles", unsortedParticlesBuffer);
